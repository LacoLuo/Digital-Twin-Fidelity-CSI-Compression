...
params.scenario = 'Boston5G_3p5_sample_density_3_1_material_3_reflections';          % The adopted ray tracing scenario [check the available scenarios at https://deepmimo.net/scenarios/]
...
% System parameters
params.bandwidth = 256*30e3/1e9;;     % The bandwidth in GHz
...
params.OFDM_sampling = [1:1:256];     % The constructed channels will be calculated only at the sampled subcarriers (to reduce the size of the dataset)
